...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$update_name', category = '$update_category', price = '$update_price' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="update_category" class="box" required>
         <option value="" disabled selected>Select Category</option>
         <option value="novel" <?php if($fetch_update['category'] == 'novel') echo 'selected'; ?>>Novel</option>
         <option value="sanatan_dharma" <?php if($fetch_update['category'] == 'sanatan_dharma') echo 'selected'; ?>>Sanatan Dharma</option>
         <option value="horror" <?php if($fetch_update['category'] == 'horror') echo 'selected'; ?>>Horror</option>
         <option value="horror" <?php if($fetch_update['category'] == 'other') echo 'selected'; ?>>other category</option>
         <!-- Add more categories as needed -->
      </select>
